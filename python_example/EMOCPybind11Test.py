...
import EMOC
# try ctypes to import model, also fail
# import ctypes
# EMOC=ctypes.CDLL("/Users/htian/Desktop/EMOC-main/python_example/EMOC.so")
# EMOC=ctypes.CDLL("/data/htian/EMOC-main/build/EMOC.so")
...
para = EMOC.EMOCParameters()
para.algorithm_name = "plvf"
para.problem_name = "DTLZ2"
para.population_num = 100
para.decision_num = 10
para.objective_num = 3
para.max_evaluation = 25000
para.output_interval = 10000
