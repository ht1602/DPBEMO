...
namespace emoc {
	...
	void InitMultiDisplayList(std::vector<char*>& display_names)
	{
		...
		display_names.push_back("IGD-CF");
	}
	...
	void InitPlotMetricList(std::vector<char*>& plot_metric_names)
	{
        ...
        plot_metric_names.push_back("HV");
        plot_metric_names.push_back("GD");
        plot_metric_names.push_back("Spacing");
        plot_metric_names.push_back("IGDPlus");
        plot_metric_names.push_back("GDPlus");
        plot_metric_names.push_back("Population");
		plot_metric_names.push_back("IGD-CF");
	}
	...
	void GetComparedMetric(const std::string& para, const std::string& format, int parameter_index, double& metric1, double& metric2)
	{
		...
		{
			GetComparedMetric(format, res.igd_cf.metric_mean, res.igd_cf.metric_std, res.igd_cf.metric_median, res.igd_cf.metric_iqr, metric1, metric2);
		}
		else
		{
