...
namespace emoc {
	...
	public:
		...
		void Scatter2D(char* plot_cmd, int gen, char* data_file_name, char* pf_file_name, std::string algorithm_name, std::string problem_name);
		void Scatter3D(char* plot_cmd, int gen, char* data_file_name, char* pf_file_name, std::string algorithm_name, std::string problem_name);
