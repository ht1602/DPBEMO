...
PYBIND11_MODULE(EMOC, m) {
	...
	py::class_<EMOCParameters>(m, "EMOCParameters")
		...
		.def_readwrite("runs_num", &EMOCParameters::runs_num)
		//新增参数algorithm_parameters
		.def_readwrite("weight_DM", &EMOCParameters::weight_StringType);
        // .def_readwrite("algorithm_parameters", &EMOCParameters::algorithm_parameters);
        // .def_readwrite("algorithm_param_num",  &EMOCParameters::algorithm_param_num)
        // .def_readwrite("problem_parameters", &EMOCParameters::problem_parameters)
        // .def_readwrite("problem_param_num", &EMOCParameters::problem_param_num);
	...
	py::class_<emoc::EMOCGeneralResult>(m, "EMOCGeneralResult")
		...
		.def_readwrite("igd_cf",&emoc::EMOCGeneralResult::igd_cf);
