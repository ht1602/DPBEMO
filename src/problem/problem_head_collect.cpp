...
namespace emoc{
	...
	// Mujoco Series
	EMOC_REGIST_PROBLEM(Multiobjective, Mujoco Series, Swimmer);

	// Protein Series
	EMOC_REGIST_PROBLEM(Multiobjective, Biology Series, Antigen);
	EMOC_REGIST_PROBLEM(Multiobjective, Biology Series, RNA);
	...
	EMOC_REGIST_PROBLEM(Singleobjective, Single Objective, Booth);
	EMOC_REGIST_PROBLEM(Singleobjective, Single Objective, ThreeHumpCamel);
	EMOC_REGIST_PROBLEM(Singleobjective, Single Objective, Easom);
	EMOC_REGIST_PROBLEM(Singleobjective, Single Objective, StyblinskiTang);
