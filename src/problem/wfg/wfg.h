...
namespace emoc {
	...
	class WFG41 :public WFG
	{
	public:
		WFG41(int dec_num, int obj_num);
		virtual ~WFG41();

		void CalObj(Individual *ind);
	};

	class WFG42 :public WFG
	{
	public:
		WFG42(int dec_num, int obj_num);
		virtual ~WFG42();

		void CalObj(Individual *ind);
	};

	class WFG43 :public WFG
	{
	public:
		WFG43(int dec_num, int obj_num);
		virtual ~WFG43();

		void CalObj(Individual *ind);
	};

	class WFG44 :public WFG
	{
	public:
		WFG44(int dec_num, int obj_num);
		virtual ~WFG44();

		void CalObj(Individual *ind);
	};

	class WFG48 :public WFG
	{
	public:
		WFG48(int dec_num, int obj_num);
		virtual ~WFG48();

		void CalObj(Individual *ind);
	};

	class WFG45 :public WFG
	{
	public:
		WFG45(int dec_num, int obj_num);
		virtual ~WFG45();

		void CalObj(Individual *ind);
	};

	class WFG46 :public WFG
	{
	public:
		WFG46(int dec_num, int obj_num);
		virtual ~WFG46();

		void CalObj(Individual *ind);
	};

	class WFG47 :public WFG
	{
	public:
		WFG47(int dec_num, int obj_num);
		virtual ~WFG47();
