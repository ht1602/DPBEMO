...
namespace emoc {
	...
	void WFG::WFG42_shape (double *y, int y_size, double *result)
	{
		int i;
	...
	void WFG::WFG43_shape (double *y, int y_size, double *result)
	{
		int i;
	...
	void WFG::WFG44_shape (double *y, int y_size, double *result)
	{
		int i;
	...
	void WFG::WFG45_shape (double *y, int y_size, double *result)
	{
		int i;
	...
	void WFG::WFG46_shape (double *y, int y_size, double *result)
	{
		int i;

		calculate_x (y, temp, y_size);
		for (i = 1; i <= y_size; i++)
			result[i - 1] = linear (temp, obj_num_, i);

		calculate_f (1.0, temp[y_size - 1], result, y_size, result);
	}

	void WFG::WFG47_shape (double *y, int y_size, double *result)
	{
		int i;

		calculate_x (y, temp, y_size);
		for (i = 1; i <= y_size - 1; i++)
			result[i - 1] = concave (temp, obj_num_, i);
		result[y_size - 1] = disc(temp, 2, 0.5, 0.5);

		calculate_f (1.0, temp[y_size - 1], result, y_size, result);
	}

	void WFG::WFG48_shape (double *y, int y_size, double *result)
	{
		int i;

		calculate_x (y, temp, y_size);
		for (i = 1; i <= y_size - 1; i++)
			result[i - 1] = convex (temp, obj_num_, i);
		result[y_size - 1] = disc (temp, 2, 0.5, 0.5);
	...
	WFG41::WFG41(int dec_num, int obj_num) : WFG(dec_num, obj_num)
	{
		decision_num = dec_num;
		objective_num = obj_num;
		for (int i = 0; i < dec_num; ++i)
	...
	void WFG41::CalObj (Individual *ind)
	{
		int size = 0;
		double *xreal = ind->dec_.data();
		double *obj = ind->obj_.data();
	...
	WFG42::WFG42(int dec_num, int obj_num) : WFG(dec_num, obj_num)
	{
		decision_num = dec_num;
		objective_num = obj_num;
		for (int i = 0; i < dec_num; ++i)
	...
	void WFG42::CalObj (Individual *ind)
	{
		int size = 0;
		double *xreal = ind->dec_.data();
		double *obj = ind->obj_.data();
	...
	WFG43::WFG43(int dec_num, int obj_num) : WFG(dec_num, obj_num)
	{
		decision_num = dec_num;
		objective_num = obj_num;
		for (int i = 0; i < dec_num; ++i)
	...
	void WFG43::CalObj (Individual *ind)
	{
		int size = 0;
		double *xreal = ind->dec_.data();
		double *obj = ind->obj_.data();
	...
	WFG44::WFG44(int dec_num, int obj_num) : WFG(dec_num, obj_num)
	{
		decision_num = dec_num;
		objective_num = obj_num;
		for (int i = 0; i < dec_num; ++i)
	...
	void WFG44::CalObj (Individual *ind)
	{
		int size = 0;
		double *xreal = ind->dec_.data();
		double *obj = ind->obj_.data();
	...
	WFG45::WFG45(int dec_num, int obj_num) : WFG(dec_num, obj_num)
	{
		decision_num = dec_num;
		objective_num = obj_num;
		for (int i = 0; i < dec_num; ++i)
	...
	void WFG45::CalObj (Individual *ind)
	{
		int size = 0;
		double *xreal = ind->dec_.data();
		double *obj = ind->obj_.data();
	...
	WFG46::WFG46(int dec_num, int obj_num) : WFG(dec_num, obj_num)
	{
		decision_num = dec_num;
		objective_num = obj_num;
		for (int i = 0; i < dec_num; ++i)
	...
	void WFG46::CalObj (Individual *ind)
	{
		int size = 0;
		double *xreal = ind->dec_.data();
		double *obj = ind->obj_.data();
	...
	WFG47::WFG47(int dec_num, int obj_num) : WFG(dec_num, obj_num)
	{
		decision_num = dec_num;
		objective_num = obj_num;
		for (int i = 0; i < dec_num; ++i)
	...
	void WFG47::CalObj (Individual *ind)
	{
		int size = 0;
		double *xreal = ind->dec_.data();
		double *obj = ind->obj_.data();
	...
	WFG48::WFG48(int dec_num, int obj_num) : WFG(dec_num, obj_num)
	{
		decision_num = dec_num;
		objective_num = obj_num;
		for (int i = 0; i < dec_num; ++i)
	...
	void WFG48::CalObj (Individual *ind)
	{
		int size = 0;
		double *xreal = ind->dec_.data();
		double *obj = ind->obj_.data();
