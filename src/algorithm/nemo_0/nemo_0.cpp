#include "algorithm/nemo_0/nemo_0.h"
#include <vector>
#include <queue>
#include <algorithm>
#include <iostream>
...
namespace emoc {
    ...
    void NEMO_0::Solve()
    {
        ...
        while (!IsTermination())
        {
            cout << "begin each iteration" << endl;
            ...
            cout << "ready to EnvironmentalSelection" << endl;
    ...
    {
        cout << "NEMO_0::RankViaPreference" << endl;
        ...
        number_of_inquiries = g_GlobalSettings->max_evaluation_ / g_GlobalSettings->population_num_ / g_GlobalSettings->tau_;
        std::cout << number_of_inquiries << std::endl;
    ...
    {
        cout << "NEMO_0::EnvironmentalSelection" << endl;
    ...
    bool NEMO_0::LP_Solver(double * row, int size, int obj_num)
    {
        ...
        cout << "NEMO_0::LP_Solver returns." << endl;
