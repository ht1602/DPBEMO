...
namespace emoc{
    ...
    void IEMOD::Solve()
    {
        ...
        while (!IsTermination())
        {
            if(g_GlobalSettings->iteration_num_ >= first_tau && g_GlobalSettings->iteration_num_ % g_GlobalSettings->tau_ == 0)
            {
                int number_of_inquiries = (int)(maxGen / g_GlobalSettings->tau_);
        ...
        {
            CalculateMinDis(weight_, g_GlobalSettings->parent_population_.data(), g_GlobalSettings->population_num_, g_GlobalSettings->obj_num_, g_GlobalSettings->dec_num_, g_GlobalSettings->problem_name_, g_GlobalSettings->algorithm_name_, g_GlobalSettings->RNA_ID_);
            CalculateExpectDis(weight_, g_GlobalSettings->parent_population_.data(), g_GlobalSettings->population_num_, g_GlobalSettings->obj_num_, g_GlobalSettings->dec_num_, g_GlobalSettings->problem_name_, g_GlobalSettings->algorithm_name_, g_GlobalSettings->RNA_ID_);
        }
       else
        {
