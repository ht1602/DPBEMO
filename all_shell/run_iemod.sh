...
do
	...
	do
		if [ "$problem" == "1" ];then
			...
			# ./EMOC -a $alg -p DTLZ$problem -M 5 -D 14 -N 128 -e 147200 -r 20 -W 0.7,0.6,0.3,0.8,0.5 -q 50&
			# # ./EMOC -a $alg -p DTLZ$problem -M 5 -D 14 -N 128 -e 147200 -r 20 -W 0.3,0.1,0.4,0.2,0.3 -q 25&
			# ./EMOC -a $alg -p DTLZ$problem -M 8 -D 17 -N 224 -e 291200 -r 20 -W 0.6,0.5,0.75,0.2,0.3,0.55,0.7,0.6 -q 50&
			# # ./EMOC -a $alg -p DTLZ$problem -M 8 -D 17 -N 224 -e 291200 -r 20 -W 0.3,0.1,0.4,0.25,0.1,0.15,0.4,0.25 -q 25&
			# ./EMOC -a $alg -p DTLZ$problem -M 10 -D 19 -N 288 -e 403200 -r 20 -W 0.3,0.3,0.3,0.1,0.3,0.55,0.35,0.35,0.25,0.45 -q 50&
